...
namespace Assets.WordBlock
{
    public class WordList
    {
        ...
        public static List<string> ThreeLetterWords = new List<string>
        {
            "and", "ant", "any", "are", "arm", "art", "ask", "bad", "bag", "bat",
            "bed", "beg", "big", "bit", "box", "boy", "bus", "but", "can", "cat",
            "cow", "cry", "cut", "day", "dog", "dry", "ear", "eat", "egg", "end",
            "far", "fat", "fly", "fun", "get", "gig", "got", "gun", "hat", "hen",
            "hot", "ice", "ink", "jam", "jar", "jet", "job", "joy", "key", "kid",
            "leg", "let", "log", "man", "map", "mat", "mix", "net", "new", "not",
            "now", "nut", "off", "old", "one", "out", "own", "pen", "pet", "pig",
            "pot", "put", "rat", "red", "run", "sat", "see", "set", "sit", "sun",
            "tap", "ten", "the", "top", "toy", "try", "two", "use", "van", "war",
            "wet", "win", "yes", "you", "zip", "zoo"
        };

        public static List<string> FourLetterWords = new List<string>
        {
